export async function run(supabase, competitionId = null) {
    ...
    console.log(`Starting: Clean Sheet Streak (Season: ${SEASON}${competitionId ? `, Competition: ${competitionId}` : ''})`);
    ...
    const entry = {
        ...
        season: SEASON,
        tipo: 'team_clean_sheet_streak',
        titulo: 'Cerrojo',
        descripcion: `El equipo ${name} mantuvo su portería a cero durante ${bestMax} partidos consecutivos.`,
