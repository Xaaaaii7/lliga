export async function run(supabase, competitionId = null) {
    ...
    console.log(`Starting: Dry Spell (Season: ${SEASON}${competitionId ? `, Competition: ${competitionId}` : ''})`);
    ...
    const entry = {
        ...
        season: SEASON,
        tipo: 'team_dry_spell',
        titulo: 'Pólvora mojada',
        descripcion: `El equipo ${name} ha pasado una racha de ${bestMax} partidos sin marcar ni un solo gol.`,
