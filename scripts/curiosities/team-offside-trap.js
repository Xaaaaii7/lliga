export async function run(supabase, competitionId = null) {
    ...
    console.log(`Starting: Offside (Season: ${SEASON}${competitionId ? `, Competition: ${competitionId}` : ''})`);
    ...
    const entry = {
        ...
        season: SEASON,
        tipo: 'team_offside_trap',
        titulo: 'Vivir al límite',
        descripcion: `El equipo ${leader.name} cae en fuera de juego ${avgStr} veces por partido.`,
